...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="#header" class="logo"><img src="logo.png" alt=""></a>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 ">
            <div class="box ">
              ...
              <p>
                Fomente una relación de fidelidad con sus clientes otorgando 'puntos digitales' por sus consumos, canjeables por premios o dinero electrónico
              </p>
            </div>
          </div>
          <div class="col-lg-12 col-md-12 ">
            <div class="box ">
              ...
              <h3>SASISOPA</h3>
              <p>
                Nuestro sistema facilita el cumplimiento y la administración de la norma y sus regulaciones en materia de Seguridad Industrial, Seguridad Operativa y Protección al Medio Ambiente.              </p>
            </div>
          </div>
    ...
    <!-- ======= Services Section ======= -->
    <section id="additionals-services" class="additionals-services">
      <div class="container" data-aos="fade-up">
        <div class="row">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              ...
              <p>Francisco de Montejo, 97203 Mérida, Yucatán </p>
            </div>
          </div>
